...
$t->get_ok('/options/admin/form')
  ...
  ->content_like(qr'<form action="/options/admin/useradd#usernewadmin" method="POST">');
...
$t->get_ok('/options/form')
  ...
  ->content_unlike(qr'<form action="/options/admin/useradd#usernewadmin" method="POST">');
