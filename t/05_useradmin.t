...
$t->get_ok('/admin/form')
  ...
  ->content_like(qr'<form action="/admin/useradd#usernewadmin" method="POST">');
...
is @{get_users()}, 1, 'user count ok';
$t->post_ok("/admin/usermod/$admin", form => {})
  ->status_is(302)->content_is('')->header_is(Location => '/options/form');
$t->get_ok('/options/form')->status_is(200);
error('Nur Administratoren dürfen das');
is @{get_users()}, 1, 'user count ok';
...
$t->get_ok('/admin/form')->status_is(302)
...
admin_login();
my $newpass = "$pass#";
$t->post_ok("/admin/usermod/$user", form => {newpw1 => $newpass, newpw2 => $newpass, active => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
...
my $oldpass = $pass;
$pass = $newpass;
$t->post_ok("/admin/usermod/$user", form => {newpw1 => $pass, newpw2 => $pass, active => 1, overwriteok => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
...
note 'disable user';
admin_login();
$t->post_ok("/admin/usermod/$user", form => {active => 0})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
error(q~Benutzer existiert bereits, das Überschreiben-Häkchen ist allerdings nicht gesetzt~);
is get_user($user)->{active}, 1, 'user still active';
$t->post_ok("/admin/usermod/$user", form => {active => 0, overwriteok => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
info(qq~Benutzer \&quot;$user\&quot; geändert~);
...
note 'reenable user';
admin_login();
$t->post_ok("/admin/usermod/$user", form => {active => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
error(q~Benutzer existiert bereits, das Überschreiben-Häkchen ist allerdings nicht gesetzt~);
is get_user($user)->{active}, 0, 'user still inactive';
$t->post_ok("/admin/usermod/$user", form => {active => 1, overwriteok => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
info(qq~Benutzer \&quot;$user\&quot; geändert~);
...
admin_login();
$t->post_ok("/admin/usermod/$user", form => {admin => 1, active => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
error(q~Benutzer existiert bereits, das Überschreiben-Häkchen ist allerdings nicht gesetzt~);
...
$t->get_ok('/options/form')->status_is(200)
  ...
  ->content_unlike(qr'<form action="/admin/useradd#usernewadmin" method="POST">');
admin_login();
$t->post_ok("/admin/usermod/$user", form => {admin => 1, active => 1, overwriteok => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
info(qq~Benutzer \&quot;$user\&quot; geändert~);
...
admin_login();
$t->post_ok("/admin/usermod/$user", form => {admin => 0, active => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
error(q~Benutzer existiert bereits, das Überschreiben-Häkchen ist allerdings nicht gesetzt~);
...
$t->get_ok('/admin/form')->status_is(200)
  ...
  ->content_like(qr'<form action="/admin/useradd#usernewadmin" method="POST">');
admin_login();
$t->post_ok("/admin/usermod/$user", form => {admin => 0, active => 1, overwriteok => 1})
  ->status_is(302)->content_is('')->header_is(Location => '/admin/form');
$t->get_ok('/admin/form')->status_is(200);
info(qq~Benutzer \&quot;$user\&quot; geändert~);
