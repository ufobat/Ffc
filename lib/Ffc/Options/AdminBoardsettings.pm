...
#               optionsheading, optionsexplaination, errormessage ],
    ...
    [ postlimit => 'Beitragsanzahl', qr(\A\d+\z)xmso, 1, 'number',
        ...
        'Hier kann die Anzahl der auf einer Seite gleichzeitig angezeigten Forenbeiträge sowie der Chatnachrichten beim öffnen des Chatfensters (x 5) beschränkt werden',
    ...
    [ topiclimit => 'Überschriftenanzahl', qr(\A\d+\z)xmso, 1, 'number',
        ...
        'Hier kann die Anzahl der auf einer Seite gleichzeitig angezeigten Forenüberschriften in der Themenliste und im Menü sowie in der Historie eigener Chatnachrichten beschränkt werden',
