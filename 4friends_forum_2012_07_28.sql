-- 
-- Structure for table `phpbb_attachments`
-- 
...
-- 
-- Structure for table `phpbb_forums`
-- 
...
-- 
-- Structure for table `phpbb_posts`
-- 
...
) ENGINE=MyISAM AUTO_INCREMENT=23372 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- 
-- Structure for table `phpbb_privmsgs`
-- 
...
) ENGINE=MyISAM AUTO_INCREMENT=3285 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- 
-- Structure for table `phpbb_privmsgs_to`
-- 
...
-- 
-- Structure for table `phpbb_topics`
-- 
...
) ENGINE=MyISAM AUTO_INCREMENT=865 DEFAULT CHARSET=utf8 COLLATE=utf8_bin;

-- 
-- Structure for table `phpbb_users`
-- 
