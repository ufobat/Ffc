...
$t2->json_has('/0');
$t2->json_has('/0/0');
$t2->json_is('/0/0/2', "$admin hat den Chat verlassen");
$t2->json_hasnt('/0/1');
...
$t2->json_is('/0/2/0' => ++$id);
$t2->json_is('/0/2/1' => $admin);
$t2->json_is('/0/2/2' => "$admin schaut im Chat vorbei");
$t2->json_is('/0/2/4' => 2);
$t2->json_is('/0/1/0' => ++$id);
$t2->json_is('/0/1/1' => $admin);
$t2->json_is('/0/1/2' => $str4);
$t2->json_is('/0/1/4' => 0);
$t2->json_is('/0/0/0' => ++$id);
$t2->json_is('/0/0/1' => "$admin");
$t2->json_is('/0/0/2' => "$admin hat den Chat verlassen");
$t2->json_is('/0/0/4' => 3);
...
$t3->get_ok('/topic/sort/chronological')->status_is(302);
