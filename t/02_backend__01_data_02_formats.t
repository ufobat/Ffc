...
<p>Und „<span class="quote">Hier, in dieser <img class="smiley" src="$url/themes//$theme/img/smileys/smile.svg" alt=":)" /> ... <a href="$testurl" title="Externe Webseite" target="_blank">$testurl</a> ... achso</span>“ und da" oder, <span class="username">$testuser</span>, so.</p>
...
<p>smile: <img class="smiley" src="$url/themes//$theme/img/smileys/smile.svg" alt=":)" /> <img class="smiley" src="$url/themes//$theme/img/smileys/smile.svg" alt=":-)" /> <img class="smiley" src="$url/themes//$theme/img/smileys/smile.svg" alt="=)" />,</p>
