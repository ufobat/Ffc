...
<p>(<a href="$testurl" title="Externe Webseite: $testurl" target="_blank">$testurl</a>), <a href="$testimage" title="Externe Webseite: $testimage" target="_blank">$testimage</a></p>
<p>Und „<span class="quote">Hier, in dieser <img class="smiley" src="/theme/img/smileys/smile.png" alt=":)" title=":)" /> ... <a href="$testurl" title="Externe Webseite: $testurl" target="_blank">$testurl</a> ... achso</span>“ und da" oder, $testuser, so.</p>
