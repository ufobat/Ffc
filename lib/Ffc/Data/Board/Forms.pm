...
sub delete_post {
    ...
    confess qq(Keine Postid angegeben) unless $id;
    confess qq{Postid ungültig} unless $id =~ m/\A\d+\z/xms;
    my $dbh = Ffc::Data::dbh();
...
sub insert_post {
    ...
    confess q(Kein Beitrag angegeben) unless $d;
    confess qq{Beitrag ungültig, zu wenig Zeichen (min. 2)} if 2 >= length $d;
    my $cid = undef;
